...
/*   Updated: 2015/10/22 17:00:05 by larry            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Wall::Wall( int height, int width, std::list<AEntities *> list_ent, std::list<std::pair<int, int> > snake_nodes )
{
	int		rnd_x;
	int		rnd_y;
	bool	set;
...
int			Wall::coordX( void )
{
	return (this->_x);
}

int			Wall::coordY( void )
{
	return (this->_y);
}

std::string	Wall::getName( void )
{
	return ("Wall");
}
